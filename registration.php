    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Mentha Ecos</small></h1>
            </div>
            <p class="lead text-center">
Registrate en nuestra pagina para tener registro de tus compras y puedas enterarte de nuestras promociones</p>
            <div class="row">
