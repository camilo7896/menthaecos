                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <img class="img-responsive center-all-contens" src="assets/img/bhJs7rhP_400x400.jpg">
                            <p class="text-center">
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          ...
          <div class="modal-body">
            ...
            <p>
              <strong>Nombre del banco:</strong> <?php echo $datBank['NombreBancoBancolombia']; ?><br>
              <strong>Numero de cuenta:</strong> <?php echo $datBank['NumeroCuentaBancolombia']; ?><br>
