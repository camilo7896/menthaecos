              ...
              <form action="./process/regBank.php" method="POST" role="form" class="FormCatElec" data-form="save">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                <label class="control-label">Numero de cuenta</label>
                                <input class="form-control" type="text" name="bancoCuentaDaviplata" maxlength="50" required="">
                            </div> 
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                <label class="control-label">Nombre del banco</label>
                                <input class="form-control" type="text" name="bancoNombreDaviplata" maxlength="50" required="">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                <label class="control-label">Nombre del beneficiario</label>
                                <input class="form-control" type="text" name="bancoBeneficiarioDaviplata" maxlength="50" required="">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                <label class="control-label">Tipo de cuenta</label>
                                <input class="form-control" type="text" name="bancoTipoDaviplata" maxlength="50" required="">
                            </div>
                        </div>
                    </div>
                </div>
